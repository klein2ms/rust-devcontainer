...
A 🦀 Rust development container for Visual Studio Code.
...
```sh
curl -L https://github.com/klein2ms/rust-devcontainer/archive/master.tar.gz | tar -xz --strip=2 rust-devcontainer-master/template/.devcontainer
```
